...
const Footer = () => {
  return (
    <footer className="bg-[#DAEAF8] border-t border-t-gray-200 py-8"> {/* Added background color */}
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold text-gray-800">Job Hunt</h2> {/* Darkened text for better contrast */}
            <p className="text-sm text-gray-700">© 2024 Your Company. All rights reserved.</p>
          </div>
          
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://facebook.com" className="text-gray-700 hover:text-gray-900" aria-label="Facebook"> {/* Darkened icons */}
            ...
            <a href="https://linkedin.com" className="text-gray-700 hover:text-gray-900" aria-label="LinkedIn">
